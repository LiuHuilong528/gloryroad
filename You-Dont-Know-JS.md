...
```
=======
>>>>>>> a970cc433978f30b1b3f1f596a451c7c854a01e1
...
### 程序性能
"Web Worker" 是浏览器特性，与 js 语言本身没有任何关系。    
浏览器可以提供多个JavaScript引擎实例，每个都在自己的线程上，允许在每个线程上运行不同的程序——分离的线程块儿中的每个都称为 "(Web) Worker"。这是"任务并行机制"
